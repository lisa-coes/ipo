...
- attempts a model easy to memorize and related with the analysis workflow (Input-Production-Output=!PO), where production refers to processing and analyzing data.
